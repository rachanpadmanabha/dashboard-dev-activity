...
const TopPerformerCard: React.FC = () => {
  ...
  return (
    <div
      ...
      } w-fit max-w-screen-sm bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 p-6 shadow-xl rounded-xl transform transition-all duration-500 hover:scale-110 hover:rotate-2`}
    >

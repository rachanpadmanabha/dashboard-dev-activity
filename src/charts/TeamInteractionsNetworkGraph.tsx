...
const TeamInteractionsNetworkGraph: React.FC = () => {
  ...
  const nodes = data.AuthorWorklog.rows.map((row) => ({
    ...
    size: (row.totalActivity.length + 1) * 0.5, // Node size based on activity count
  ...
  return (
    <div className="relative w-full h-[450px] overflow-hidden">
      ...
      <ForceGraph3D
        ...
        nodeRelSize={10} // Adjusted node size
        linkDirectionalParticles={2} // Slightly more particles
        linkDirectionalParticleSpeed={0.05} // Adjusted speed of the particles
        linkWidth={2} // Thinner links
        ...
        width={600} // Constrained width of the graph
        height={450} // Constrained height of the graph
      />
    </div>
  );
};
